...
public class AuthorizationServerConfiguration extends AuthorizationServerConfigurerAdapter {
    ...
    public void configure(ClientDetailsServiceConfigurer configurer) throws Exception {
        ...
        configurer.inMemory()  // 使用in-memory存储
                ...
                .and().withClient("svca-service").secret(new BCryptPasswordEncoder().encode("password"))
				.authorizedGrantTypes(GRANT_TYPE, REFRESH_TOKEN).scopes("server")
				.and().withClient("svcb-service").secret(new BCryptPasswordEncoder().encode("password"))
				.authorizedGrantTypes(GRANT_TYPE, REFRESH_TOKEN).scopes("server");
